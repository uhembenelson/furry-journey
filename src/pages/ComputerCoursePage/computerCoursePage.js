...
import { loadAllComputerCourse } from "../../DataStore/CourseReducer";
import Api from "../../Api";
...
export default function ComputerCoursePage(props) {
    const courseListStatus = useSelector(state => state.course.loadAllComputerCourse)
    const dispatch = useDispatch();
    const [mounted, setMounted] = useState(false)
    useEffect(() => {
        if (!mounted) {
            dispatch(loadAllComputerCourse({
